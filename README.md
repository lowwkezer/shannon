...
- On macOS, open the downloaded `.dmg` or unzip it, then drag the app to your Applications folder.
- On Linux, make the file executable by running `chmod +x filename` in the terminal, then launch it.
